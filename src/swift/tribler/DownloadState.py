...
import sys
from src.swift.tribler.Base import Serializable
from src.swift.tribler.simpledefs import DLSTATUS_STOPPED_ON_ERROR,\
    DLSTATUS_DOWNLOADING, DLSTATUS_SEEDING, DLSTATUS_WAITING4HASHCHECK, UPLOAD,\
    DLSTATUS_STOPPED
