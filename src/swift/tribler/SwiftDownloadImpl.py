...
from src.swift.tribler.SwiftDownloadRuntimeConfig import SwiftDownloadRuntimeConfig
from src.swift.tribler.globals import DownloadStartupConfig
from src.swift.tribler.simpledefs import DLSTATUS_WAITING4HASHCHECK, DOWNLOAD,\
    UPLOAD, DLSTATUS_STOPPED, DLMODE_VOD, DLSTATUS_SEEDING, VODEVENT_START,\
    PERSISTENTSTATE_CURRENTVERSION, DLMODE_NORMAL, dlstatus_strings
from src.swift.tribler import DownloadState
from src.swift.tribler.exceptions import OperationNotEnabledByConfigurationException
from src.swift.tribler.DownloadConfig import DownloadConfigInterface
